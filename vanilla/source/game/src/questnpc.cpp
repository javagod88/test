...
namespace quest
{
	...
	bool NPC::OnBuy(PC& pc)
	{
		return HandleReceiveAllEvent(pc, QUEST_BUY_EVENT);
	}
	...
	bool NPC::OnMessage(PC & pc)
	{
		//PROF_UNIT puOnKill("quest::NPC::OnKill");
		if (m_vnum)
		{
			//PROF_UNIT puOnKill1("onk1");
			return HandleEvent(pc, QUEST_PLAYER_MESSAGE_EVENT);
		}
		else
		{
			//PROF_UNIT puOnKill2("onk2");
			return HandleReceiveAllEvent(pc, QUEST_PLAYER_MESSAGE_EVENT);
		}
	}

	bool NPC::OnPlayerKill(PC & pc)
	{
		//PROF_UNIT puOnKill("quest::NPC::OnKill");
		if (m_vnum)
		{
			//PROF_UNIT puOnKill1("onk1");
			return HandleEvent(pc, QUEST_PLAYER_KILL_EVENT);
		}
		else
		{
			//PROF_UNIT puOnKill2("onk2");
			return HandleReceiveAllEvent(pc, QUEST_PLAYER_KILL_EVENT);
		}
	}

	bool NPC::OnPlayerPartyKill(PC & pc)
	{
		if (m_vnum)
		{
			return HandleEvent(pc, QUEST_PLAYER_PARTY_KILL_EVENT);
		}
		else
		{
			return HandleReceiveAllEvent(pc, QUEST_PLAYER_PARTY_KILL_EVENT);
		}
	}

	bool NPC::OnUniqueKill(PC & pc)
	{
		//PROF_UNIT puOnKill("quest::NPC::OnKill");
		if (m_vnum)
		{
			//PROF_UNIT puOnKill1("onk1");
			return HandleEvent(pc, QUEST_UNIQUE_KILL_EVENT);
		}
		else
		{
			//PROF_UNIT puOnKill2("onk2");
			return HandleReceiveAllEvent(pc, QUEST_UNIQUE_KILL_EVENT);
		}
	}
	...
	bool NPC::OnExecute(PC& pc)
	{
		return HandleReceiveAllEvent(pc, QUEST_EXECUTE_EVENT);
	}
